...
# Tests require v0.9.1+ but skip on v0.11.0+ (worktree behavior changed)
pytestmark = [
    pytest.mark.skipif(
        _version < (0, 9, 1),
    ...
    pytest.mark.skipif(
        _version >= (0, 11, 0),
        reason="Skipped on v0.11.0+ (worktree workflow changed, create-feature no longer creates worktrees)"
    )
]
