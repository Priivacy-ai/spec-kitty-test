...
# Skip on v0.11.0+ (worktree workflow changed - planning now in main repo)
pytestmark = pytest.mark.skipif(
    _version >= (0, 11, 0),
    reason="Tests v0.10.x worktree constitution behavior - skipped on v0.11.0+ (worktree workflow changed)"
)
