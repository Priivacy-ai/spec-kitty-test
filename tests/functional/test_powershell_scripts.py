...
# Skip on v0.11.0+ (PowerShell scripts for Issues #26/#27 - command structure changed)
pytestmark = pytest.mark.skipif(
    _version >= (0, 11, 0),
    reason="Tests v0.10.x PowerShell scripts - skipped on v0.11.0+ (command structure changed)"
)
